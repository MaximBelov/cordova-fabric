...
#curl -o ./tmp/fabric.zip "https://kit-downloads.fabric.io/cocoapods/fabric/1.9.0/fabric.zip"
#curl -o ./tmp/crashlytics.zip "https://kit-downloads.fabric.io/cocoapods/crashlytics/$CRASH_VERSION/crashlytics.zip"
#curl -o ./tmp/crashlytics.zip "https://kit-downloads.fabric.io/cocoapods/crashlytics/3.13.4/crashlytics.zip"
...
#mv ./tmp/crashlytics/iOS/Crashlytics.framework ./lib/ios/
#mv ./tmp/fabric/iOS/Fabric.framework ./lib/ios/
